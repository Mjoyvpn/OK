...
LLatest=`date`
Get_Data () {
git clone https://github.com/joysmark/user-backup-db.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git push -f https://TOKEN Github@github.com/joysmark/user-backup-db.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/Mjoyvpn/OK/main/$NameUser/$NameUser.zip"
sleep 1
