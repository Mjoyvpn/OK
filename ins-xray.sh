...
wget -q "https://raw.githubusercontent.com/Mjoyvpn/OK/main/xray-core.sh" && chmod +x xray-core.sh && ./xray-core.sh >/dev/null 2>&1
rm -f xray-core.sh
sleep 1
echo -e "[ ${green}INFO$NC ] Downloading & Installing Trojan-Go"
wget -q "https://raw.githubusercontent.com/Mjoyvpn/OK/main/ins-trojango.sh" && chmod +x ins-trojango.sh && ./ins-trojango.sh
